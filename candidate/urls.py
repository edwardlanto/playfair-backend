...
urlpatterns = [
    ...
    path('logo/update', views.upload_candidate_logo,name='uploadCandidateLogo'),
    ...
    path('profile/jobs/applied-jobs/', views.get_applied_jobs, name='get_applied_jobs'),
    path('profile/contracts/applied-contracts', views.get_applied_contracts, name='get_applied_contracts'),
