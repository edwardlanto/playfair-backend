...
def update_my_company(request):
    ...
    company.description = bleach.clean(data['description'], tags=bleached_tags) if data['description'] else None
...
def update_job(request, pk):
    ...
    location = geolocator.reverse(f'{request.data["lat"]}, {request.data["long"]}')
