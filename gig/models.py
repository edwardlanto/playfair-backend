...
class Gig(models.Model):
    ...
    seller = models.OneToOneField(CustomUserModel, on_delete=models.SET_NULL, null=True, related_name="gig_seller")
    buyer = models.OneToOneField(CustomUserModel, on_delete=models.SET_NULL, null=True, related_name="gig_buyer")
