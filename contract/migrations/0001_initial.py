# Generated by Django 4.2.1 on 2023-07-05 04:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('cancelled', 'Cancelled'), ('error', 'Error'), ('pending', 'Pending'), ('success', 'Success')], default='pending', max_length=10)),
                ...
                ('buyer', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contract_buyer', to=settings.AUTH_USER_MODEL)),
                ('seller', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contract_seller', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'contract',
            },
