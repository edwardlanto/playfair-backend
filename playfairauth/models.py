...
class CustomUserProfile(models.Model):
    ...
    postal_code = models.CharField(max_length=10, default="", null=True, blank=True)
    bio = RichTextField(null=True, default="", blank=True)
    ...
    linkedIn = models.CharField(max_length=100, default="", null=True, blank=True)
    instagram = models.CharField(max_length=100, default="", null=True, blank=True)
    first_name = models.CharField(max_length=100, null=True)
    last_name = models.CharField(max_length=100, null=True)
    title = models.CharField(max_length=100, null=True)
    education_level = models.CharField(max_length=100, default="", null=True, blank=True)
    rating = models.CharField(max_length=5, null=True, blank=True)
    unit = models.CharField(max_length=10, null=True, blank=True)
    logo = models.FileField(null=True, blank=True)
    industry = models.CharField(max_length=100, null=True, default="", blank=True)
